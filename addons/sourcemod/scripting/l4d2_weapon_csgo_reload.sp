...
public void OnPluginStart()
{
	...
	hEnable					= CreateConVar("l4d2_weapon_csgo_reload_allow", 		"1", 	"0=禁用插件, 1=启用插件" 			  , FCVAR_NOTIFY, true, 0.0, true, 1.0);
	hEnableClipRecoverCvar	= CreateConVar("l4d2_weapon_csgo_reload_clip_recover", 	"1", 	"是否启用插件功能?"			  , FCVAR_NOTIFY, true, 0.0, true, 1.0);
	hSmgTimeCvar			= CreateConVar("l4d2_smg_reload_clip_time", 			"1.8", "uzi冲锋枪换弹时间"							  , FCVAR_NOTIFY, true, 0.0);
	hRifleTimeCvar			= CreateConVar("l4d2_rifle_reload_clip_time", 			"1.2",  "m4步枪的换弹时间"							  , FCVAR_NOTIFY, true, 0.0);
	hHuntingRifleTimeCvar   = CreateConVar("l4d2_huntingrifle_reload_clip_time", 	"2.6",  "木制猎枪的换弹时间"							  , FCVAR_NOTIFY, true, 0.0);
	hPistolTimeCvar 		= CreateConVar("l4d2_pistol_reload_clip_time", 			"1.75",  "单手枪的换弹时间"								  , FCVAR_NOTIFY, true, 0.0);
	hDualPistolTimeCvar 	= CreateConVar("l4d2_dualpistol_reload_clip_time", 		"1.75", "双手枪的换弹时间"								  , FCVAR_NOTIFY, true, 0.0);
	hSmgSilencedTimeCvar	= CreateConVar("l4d2_smgsilenced_reload_clip_time", 	"2.0", "smg消音冲锋枪的换弹时间"						  , FCVAR_NOTIFY, true, 0.0);
	hSmgMP5TimeCvar			= CreateConVar("l4d2_smgmp5_reload_clip_time", 			"1.7",  "mp5冲锋枪的换弹时间"							  , FCVAR_NOTIFY, true, 0.0);
	hAK47TimeCvar			= CreateConVar("l4d2_ak47_reload_clip_time", 			"1.2",  "ak47步枪的换弹时间"							  , FCVAR_NOTIFY, true, 0.0);
	hRifleDesertTimeCvar	= CreateConVar("l4d2_desertrifle_reload_clip_time", 	"1.8",  "scar步枪的换弹时间"							  , FCVAR_NOTIFY, true, 0.0);
	hSniperMilitaryTimeCvar	= CreateConVar("l4d2_snipermilitary_reload_clip_time", 	"1.8",  "军用狙击枪的换弹时间"							  , FCVAR_NOTIFY, true, 0.0);
	hGrenadeTimeCvar		= CreateConVar("l4d2_grenade_reload_clip_time", 		"2.5",  "榴弹发射器的换弹时间"							  , FCVAR_NOTIFY, true, 0.0);
	hSG552TimeCvar			= CreateConVar("l4d2_sg552_reload_clip_time", 			"1.6",  "sg552步枪的换弹时间"							  , FCVAR_NOTIFY, true, 0.0);
	hAWPTimeCvar			= CreateConVar("l4d2_awp_reload_clip_time", 			"2.0",  "awp狙击枪的换弹时间"							  , FCVAR_NOTIFY, true, 0.0);
	hScoutTimeCvar			= CreateConVar("l4d2_scout_reload_clip_time", 			"1.45", "scout狙击枪的换弹时间"						  , FCVAR_NOTIFY, true, 0.0);
	hMangumTimeCvar			= CreateConVar("l4d2_mangum_reload_clip_time", 			"1.75", "马格南的换弹时间"								  , FCVAR_NOTIFY, true, 0.0);
	hM60TimeCvar			= CreateConVar("l4d2_m60_reload_clip_time", 			"1.2",  "m60的换弹时间"								  , FCVAR_NOTIFY, true, 0.0);
