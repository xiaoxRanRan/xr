...
public void OnPluginStart()
{
    ...
    g_hCvar_SurvivorTeam      = CreateConVar("l4d_hp_laser_survivor_team", "0", "幸存者可以看到哪些队伍的激光束HP.\n0 = 无, 1 = 生还者, 2 = 感染者, 4 = 旁观者, 8 = HOLDOUT（抵抗者？）.\n如果有多个选项，则添加大于0的数字.\n例如：3表示启用生还者和感染者", CVAR_FLAGS, true, 0.0, true, 15.0);
    g_hCvar_InfectedTeam      = CreateConVar("l4d_hp_laser_infected_team", "0", "感染者可以看到哪些队伍的激光束HP.\n0 = 无, 1 = 生还者, 2 = 感染者, 4 = 旁观者, 8 = HOLDOUT（抵抗者？）.\n如果有多个选项，则添加大于0的数字.\n例如：3表示启用生还者和感染者", CVAR_FLAGS, true, 0.0, true, 15.0);
